...
{
    public class C003_DatabaseInfo
    {
        private static volatile C003_DatabaseInfo _instance;
        ...
        public static C003_DatabaseInfo Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    {
                        if (_instance == null)
                            _instance = new C003_DatabaseInfo();
                    }
                }
